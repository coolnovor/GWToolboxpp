...
struct MusicData {
    ...
    static_assert(sizeof(MusicData) == 0x3C, "音乐数据大小不匹配");
    ...
    static_assert(sizeof(SoundScriptContext) == 0xA8, "声音脚本上下文大小不匹配");
...
void AudioSettings::Initialize()
{
    ...
    PlaySound_Func = (PlaySound_pt)GW::Scanner::ToFunctionStart(GW::Scanner::FindAssertion("SndMain.cpp","文件名",0,0));
